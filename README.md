...
## Guide and screenshots : USE AT YOUR OWN RISK, STILL IN BETA
  ...
  ### Creating a configuration, which is the requirements for the axies [Botaxie](http://botaxie.org) will buy for you 
...
![Configurations](https://github.com/Botaxie/botaxie/raw/main/screenshots/configs.png)
  ...
  ### Launching an bot instance for a configuration
  ### IMPORTANT : NEVER USE YOUR MAIN ACCOUNT TO AVOID GETTING BANNED
  #### *Always create a new wallet, login with it and email verify it on the axie marketplace, transfer only the WETH for the axies you want to buy, + the 4% fee*
